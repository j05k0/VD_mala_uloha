...
# Dataset with 10000 records
vehicle_data = pd.read_csv("big_dataset.csv")
...
with open('big_dataset.csv', 'rb') as medium:
...
plt.savefig("vehicles_big.png", bbox_inches="tight")
